...
class PostgresNixSqldelightDriverTest {
    ...
    @Test
    fun allTypes() = runTest {
        val queries = NativePostgres(driver).fooQueries
        NativePostgres.Schema.awaitMigrate(driver, 0, NativePostgres.Schema.version)
    ...
    fun copyTest() = runTest {
        ...
        val result = driver.copy(
            sequenceOf("42,answer,2020-12-12,12:42:00.0000,2014-08-01T12:01:02.0000,1970-01-01T00:00:00.010Z,PT42S,00000000-0000-0000-0000-000000000000")
        )
